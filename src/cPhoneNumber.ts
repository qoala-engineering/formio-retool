...
class CPhoneNumber extends Field {
  ...
  attach(element: any): any {
    ...
    if(currentValue && currentValue.dialCode && currentValue.value) {
      // Update UI for dial code
      (this.refs as any).refDialCode.innerText = `${currentValue.dialCode}`;
      (this.refs as any).selectDialCode.value = `${currentValue.dialCode}`;
      // Update UI for phone number
      (this.refs as any).refPhoneNumber.value = currentValue.value;
    }
